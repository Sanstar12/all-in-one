...
from unzipper import boottime, LOGGER
from devgagan import app
from devgagan.core.filters import archive_filter
...
@app.on_message(filters.private & archive_filter)
...
@app.on_message(filters.private & filters.command("clean") & archive_filter)
...
@app.on_message(archive_filter & filters.command("help"))
...
@app.on_message(archive_filter & filters.command("about"))
...
@app.on_message(archive_filter & filters.command("privacy"))
...
@app.on_message(filters.private & filters.command("done") & archive_filter)
...
@app.on_message(archive_filter & filters.command("stats"))
...
@app.on_message(archive_filter & filters.command("broadcast") & filters.user(Config.BOT_OWNER))
...
@app.on_message(archive_filter & filters.command("sendto") & filters.user(Config.BOT_OWNER))
...
@app.on_message(archive_filter & filters.command("report"))
...
@app.on_message(archive_filter & filters.command("ban") & filters.user(Config.BOT_OWNER))
...
@app.on_message(archive_filter & filters.command("unban") & filters.user(Config.BOT_OWNER))
...
async def me_stats(_, message: Message):
    ...
    await app.send_message(chat_id=message.chat.id, text=f"`{me_info}`")


@app.on_message(archive_filter & filters.command("user") & filters.user(Config.BOT_OWNER))
...
@app.on_message(archive_filter & filters.command("user2") & filters.user(Config.BOT_OWNER))
async def info_user2(_, message: Message):
    ...
    try:
        ...
        return
    try:
        infos = await app.get_users(user_id)
    except:
...
@app.on_message(archive_filter & filters.command("self") & filters.user(Config.BOT_OWNER))
async def info_self(_, message: Message):
    self_infos = await app.get_me()
...
@app.on_message(filters.private & filters.command("addthumb") & archive_filter)
async def thumb_add(_, message: Message):
    await add_thumb(app, message)


@app.on_message(filters.private & filters.command("delthumb") & archive_filter)
...
async def send_logs(user_id):
    with open("unzip-log.txt", "rb") as doc_f:
        try:
            ...
            await app.send_message(chat_id=user_id, text=e)
...
@app.on_message(archive_filter & filters.command("donate"))
async def donate_help(_, message: Message):
    await message.reply(Messages.DONATE_TEXT)


@app.on_message(archive_filter & filters.command("vip"))
...
@app.on_message(archive_filter & filters.command("commands"))
...
@app.on_message(archive_filter & filters.command("admincmd") & filters.user(Config.BOT_OWNER))
...
@app.on_message(archive_filter & filters.command("eval") & filters.user(Config.BOT_OWNER))
...
@app.on_message(archive_filter & filters.command("exec") & filters.user(Config.BOT_OWNER))
