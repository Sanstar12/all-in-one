...
@app.on_message(filters.command("help") & archive_filter)
...
@app.on_message(filters.command("about") & archive_filter)
...
@app.on_message(filters.command("privacy") & archive_filter)
...
@app.on_message(filters.command("broadcast") & filters.user(Config.BOT_OWNER))
...
@app.on_message(filters.command("sendto") & filters.user(Config.BOT_OWNER))
...
@app.on_message(filters.command("ban") & filters.user(Config.BOT_OWNER))
...
@app.on_message(filters.command("unban") & filters.user(Config.BOT_OWNER))
...
@app.on_message(filters.command("user") & filters.user(Config.BOT_OWNER))
...
@app.on_message(filters.command("user2") & filters.user(Config.BOT_OWNER))
...
@app.on_message(filters.command("self") & filters.user(Config.BOT_OWNER))
...
@app.on_message(filters.private & filters.command("addthumb"))
...
@app.on_message(filters.command("admincmd") & filters.user(Config.BOT_OWNER))
...
@app.on_message(filters.command("eval") & filters.user(Config.BOT_OWNER))
...
@app.on_message(filters.command("exec") & filters.user(Config.BOT_OWNER))
