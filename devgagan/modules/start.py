from devgagan.core.filters import restricted_filter
# ---------------------------------------------------
# File Name: start.py
...
@app.on_message(restricted_filter & filters.command("set"))
async def set(_, message):
    ...
    await app.set_bot_commands([
        ...
        BotCommand("change", "🔄 Switch between Archive & Restricted mode"),
...
@app.on_message(restricted_filter & filters.command("help"))
...
@app.on_message(restricted_filter & filters.command("terms") & filters.private)
async def terms(client, message):
    ...
    buttons = InlineKeyboardMarkup(
        [
            ...
            [InlineKeyboardButton("💬 Contact Now", url="https://t.me/Bl4nk_user")],
        ]
    )
    await message.reply_text(terms_text, reply_markup=buttons)
 
 
@app.on_message(restricted_filter & filters.command("plan") & filters.private)
